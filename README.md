...
| `/dryrun <id>` | Холостой прогон копии задания через 60 с: прогрев, RTT, выстрел без отправки. Проверка связи и калибровка |
